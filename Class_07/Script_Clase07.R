...
nbs<-poly2nb(comunas_rm,queen = T) #Esto define vencidad 
...
comunas_rm$Confirmados_2020.04.17_sl<-lag.listw(w_rm,comunas_rm$Confirmados_2020.04.17) #lag.listw preguntarle dada la matriz de peso espaciales que define la estructura de vencidad que estoy planteando o imponiendo cuál es el valor de mis vecinos? 
